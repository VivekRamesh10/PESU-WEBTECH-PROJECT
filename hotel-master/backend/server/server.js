...
var rootDir = '/Users/Vivek Ramesh/Desktop/hotel-master/backend';
...
app.post('/booking',function(req,res){
    ...
    //Validate departure date & arrival date are max 2 weeks using unix epoch time
    if(departureDate < arrivalDate){
    	return res.status(400).send("Depature Date cannot be before than arrival date!!");
    }

    if(departureDate - arrivalDate > 1608422400) {
...
app.post('/modify',function(req,res){
    ...
    if(newDepartureDate - newArrivalDate > 1608422400) {
    	return res.status(400).send("Wrong Dates Selected !");
    }
